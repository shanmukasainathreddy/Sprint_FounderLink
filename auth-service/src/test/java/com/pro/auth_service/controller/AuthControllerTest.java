...
class AuthControllerTest {
    ...
    void testRegister() {
        ...
        request.setBio("Building FounderLink");

        when(authService.register("user@test.com", "pass123", "FOUNDER", "Test User", "Building FounderLink"))
        ...
        verify(authService, times(1))
                .register("user@test.com", "pass123", "FOUNDER", "Test User", "Building FounderLink");
    }
