...
import com.pro.investment_service.dto.InvestmentStatusUpdateRequest;
...
public class InvestmentController {
    ...
    @PreAuthorize("hasAnyRole('FOUNDER','ADMIN')")
    public Investment updateStatus(@PathVariable Long id, @Valid @RequestBody InvestmentStatusUpdateRequest request) {
