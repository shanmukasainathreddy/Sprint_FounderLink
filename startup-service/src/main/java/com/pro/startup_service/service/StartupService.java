...
public class StartupService {
    ...
    public Startup create(Startup startup) {
        ...
        startup.setId(null);
        startup.setUserId(resolveAuthenticatedUserId());
    ...
    public Startup update(Long id, Startup updated) {
        ...
        existing.setFundingGoal(updated.getFundingGoal());
        existing.setStage(updated.getStage());
        existing.setLocation(updated.getLocation());
        existing.setPitch(updated.getPitch());
        existing.setTeamRoles(updated.getTeamRoles());
        existing.setUserId(existing.getUserId() == null ? resolveAuthenticatedUserId() : existing.getUserId());
